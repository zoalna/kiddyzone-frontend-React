    ...
    <div class="container">
        ...
        <div class="controls">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="form_name">First Name <span class="text-red">*</span></label>
                <input id="form_name" type="text" name="name" class="form-control" required />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="form_lastname">Last Name <span class="text-red">*</span></label>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label for="form_email">Email Address <span class="text-red">*</span></label>
                <input id="form_email" type="email" name="email" class="form-control" required />
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label for="form_gps-location">GPS Location <span class="text-red">*</span></label>
                <input id="form_gps-location" type="text" placeholder="Location" name="gps-location" class="form-control" />
              </div>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label for="form_postcode_zip">Postcode / Zip <span class="text-red">*</span></label>
                <input id="form_postcode_zip" type="text" name="postcode_zip" placeholder="Postcode / Zip" class="form-control" />
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label for="form_town_city">Town / City <span class="text-red">*</span></label>
                <input id="form_town_city" type="text" name="town_city" placeholder="Town / City" class="form-control" />
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 select-mobile">
              <div class="form-group">
                <label for="form_mobile">Mobile Number <span class="text-red">*</span></label>
                <select>
                    <option value="0"><img src="image/flag.png"/> +971</option>
                    <option value="0"><img src="image/flag.png"/> +972</option>
                    <option value="0"><img src="image/flag.png"/> +973</option>
                    <option value="0"><img src="image/flag.png"/> +974</option>
                </select>
                <input id="form_mobile" type="tel" placeholder="Mobile Number" name="mobile" class="form-control" />   
              </div>
            </div>
          </div>
            ...
            <div class="col-md-4 subtotal">
                ...
                <table id="checkout-edit-cart" class="table table-hover table-right">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="media-body">
                                ...
                                <div class="amount-discount"><h3>AED 4.50</h3><h3><b>Discount:</b> AED 0.00</h3></div>
                            </div>
                            </div>
                        </td>
                    </tr> 
                ...
                <table class="table table-hover table-right">
                    ...
                    <tr>
                        <td><h5>Items Discount (you saved)</h5></td>
                        <td class="text-right"><h5><strong>AED 0.00</strong></h5></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="total-amount">
                        <td><h5>Total</h5></td>
                        <td class="text-right"><h5>AED 400</h5></td>
                    </tr>
            ...
            <div class="col-sm-12 cart-btn">
                <button type="button" class="btn bg-green place-order text-white">Place Order</button>
            </div>
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-6 right-col">
                <div class="text-center content-box">
                    ...
                    <a href="#" class="bg-green btn">Sign Up</a>
                </div>
            </div>
        </div>
    </div>
