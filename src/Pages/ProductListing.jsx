            ...
            <div className="sidebar-filter">
              ...
              <div className="categories-filter">
                ...
                <ul>
                  <li className="range">
                    {' '}
                    <input type="checkbox" id="productListing" />{' '}
                    <a href="#">
                      Magic Toy <span className="cat-count">(15)</span>
                    </a>
                  </li>
                  <li className="range">
                    {' '}
              ...
              <div className="shopbyage-filter">
                ...
                <ul>
                  <li className="range">
                    <input type="checkbox" id="productListing" />{' '}
                    <a href="#">0 to 2 years</a>
                  </li>
                  <li className="range">
                    <input type="checkbox" id="productListing" />{' '}
                    <a href="#">5 to 7 years</a>
                  </li>
                  <li className="range">
                    <input type="checkbox" id="productListing" />{' '}
                    <a href="#">7 to 10 years</a>
                  </li>
                </ul>
              </div>
              ...
              <div className="listing-top">
                ...
                <div className="product-sorting">
                  ...
                  >
                    <g
                      id="Group_4298"
                      data-name="Group 4298"
                      transform="translate(-1784 -923.896)"
                    >
                      <rect
                        id="Rectangle_473"
                      ...
                      <g id="Group_4297" data-name="Group 4297">
                        <g
                          id="Group_4059"
                          data-name="Group 4059"
                          transform="translate(1788.403 927.369)"
                        >
                          <rect
                            id="Rectangle_474"
                            ...
                            width="6"
                            height="6"
                            transform="translate(-0.403 -0.473)"
                            fill="#fff"
                          />
                          <rect
                            id="Rectangle_475"
                            ...
                            width="5"
                            height="6"
                            transform="translate(6.597 -0.473)"
                            fill="#fff"
                          />
                          <rect
                            id="Rectangle_476"
                            ...
                            width="5"
                            height="6"
                            transform="translate(12.597 -0.473)"
                            fill="#fff"
                          />
                        </g>
                        <g
                          id="Group_4058"
                          data-name="Group 4058"
                          transform="translate(1788.403 934.247)"
                        >
                          <rect
                            id="Rectangle_479"
                            ...
                            width="6"
                            height="5"
                            transform="translate(-0.403 -0.351)"
                            fill="#fff"
                          />
                          <rect
                            id="Rectangle_478"
                            ...
                            width="5"
                            height="5"
                            transform="translate(6.597 -0.351)"
                            fill="#fff"
                          />
                          <rect
                            id="Rectangle_477"
                            ...
                            width="5"
                            height="5"
                            transform="translate(12.597 -0.351)"
                            fill="#fff"
                          />
                        </g>
                        <g
                          id="Group_4057"
                          data-name="Group 4057"
                          transform="translate(1788.403 940.265)"
                        >
                          <rect
                            id="Rectangle_482"
                            ...
                            width="6"
                            height="6"
                            transform="translate(-0.403 -0.369)"
                            fill="#fff"
                          />
                          <rect
                            id="Rectangle_481"
                            ...
                            width="5"
                            height="6"
                            transform="translate(6.597 -0.369)"
                            fill="#fff"
                          />
                          <rect
                            id="Rectangle_480"
                            ...
                            width="5"
                            height="6"
                            transform="translate(12.597 -0.369)"
                            fill="#fff"
                          />
                        </g>
                      </g>
