    ...
    <div className="col-lg-3">
    	<div className="sidebar-filter"><h2>Filters</h2>
        	<div className="categories-filter">
                <h2>CATEGORIES</h2>
                <ul>
                    <li className="range"> <input type="checkbox" id="productListing" /> <a href="#">Magic Toy <span className="cat-count">(15)</span></a></li>
                    <li className="range"> <input type="checkbox" id="productListing" /> <a href="#">Magic Toy <span className="cat-count">(15)</span></a></li>
                    <li className="range"> <input type="checkbox" id="productListing" /> <a href="#">Magic Toy <span className="cat-count">(15)</span></a></li>
                    <li className="range"> <input type="checkbox" id="productListing" /> <a href="#">Magic Toy <span className="cat-count">(15)</span></a></li>
                </ul>
            ...
            <div className="shopbyage-filter">
                <h2>Shop By Ages</h2>
                <ul>
                    <li className="range"><input type="checkbox" id="productListing" /> <a href="#">0 to 2 years</a></li>
                    <li className="range"><input type="checkbox" id="productListing" /> <a href="#">5 to 7 years</a></li>
                    <li className="range"><input type="checkbox" id="productListing" /> <a href="#">7 to 10 years</a></li>
                </ul>
            </div>
